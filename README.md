...
- Architecture
  ...
  - Real Image Denoising with Knowledge Distillation for **High-Performance Mobile NPUs**. [[paper]](https://arxiv.org/html/2605.03680v1) [[code]](https://github.com/ABrain-One/NN-Dataset)
  - Efficient **Real-Time** Raw-to-Raw Denoising for Extreme Low-Light Ultra HD Video on Mobile Devices. [[CVPR 2026]](https://openaccess.thecvf.com/content/CVPR2026/papers/Pochimireddy_Efficient_Real-Time_Raw-to-Raw_Denoising_for_Extreme_Low-Light_Ultra_HD_Video_CVPR_2026_paper.pdf)
- Noise Modeling
  ...
  - (**PNNP**) Learning Physics-Informed Noise Models from Dark Frames for Low-Light Raw Image Denoising. [[TPAMI 2026]](https://arxiv.org/abs/2310.09126) [[code]](https://github.com/fenghansen/PNNP/tree/main)
  - **2-Shots in the Dark**: Low-Light Denoising with Minimal Data Acquisition. [[CVPR 2026]](https://arxiv.org/pdf/2512.03245) [[code]](https://github.com/IVRL/2-Shots-in-the-Dark)
- Dateset-related
...
- Fundamental
  ...
  - Color Constancy Using CNNs. [[CVPR 2015]](https://openaccess.thecvf.com/content_cvpr_workshops_2015/W03/papers/Bianco_Color_Constancy_Using_2015_CVPR_paper.pdf)
  ...
  - (**TLCC**) Transfer Learning for Color Constancy via Statistic Perspective. [[AAAI 2022]](https://ojs.aaai.org/index.php/AAAI/article/view/20135)
